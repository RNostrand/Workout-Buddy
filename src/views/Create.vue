    ...
    <div class="p-8 flex items-start bg-light-grey rounded-md shadow-lg mb-40">
      ...
      >
        ...
        <div class="flex flex-col">
          <label for="workout-name" class="mb-1 text-sm text-at-light-greeb"
            >Workout Name</label
          >
          <input
            type="text"
        ...
        <!--- Workout Type --->
        <div class="flex flex-col">
          <label for="workout-type" class="mb-1 text-sm text-at-light-greeb"
            >Workout Type</label
          >
          <select
            required
        ...
        <div v-if="workoutType === 'strength'" class="flex flex-col gap-y-4">
          ...
          >
            ...
            <!--- Weight --->
            <div class="flex flex-col flex-1">
              <label for="weight" class="mb-1 text-sm text-navy"
                >Weight (lbs)</label
              >
              <input
                type="text"
