<template>
  <div class="max-w-screen-sm mx-auto px-4 py-10">
    ...
    <!--- Registration ---> 
    <form @submit.prevent="register" class="p-8 flex flex-col bg-light-grey rounded-md shadow-lg mb-40">
      ...
      <!--- Confirm Password ---> 
      <div class="flex flex-col mb-2">
        <label for="confirmPassword" class="mb-1 text-sm text-navy">Confirm Password</label>
        <input 
        type="password" 
        required 
        class="p-2 text-grey-500 focus:outline-none" 
